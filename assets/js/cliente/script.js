...
function shows_edit_table(){
  ...
  for(let i = 0; i < rows; i++){
    ...
    input1.setAttribute('id','lastname'+i);
    ...
    select1.setAttribute('name','document_type[]');
    select1.setAttribute('id','document_type'+i);
    ...
    for(let i=0; i<tiposDocumentos.length; i++) {
      ...
      option.setAttribute('value',tiposDocumentos[i].id);
      option.innerHTML = tiposDocumentos[i].name;
      select1.append(option);
    }
    
    let td1_1 = document.createElement("td");
    let input1_1 = document.createElement('input');
    input1_1.setAttribute('id','document'+i);
    input1_1.setAttribute('name','document[]');
    ...
    input3.setAttribute('id','phone'+i);
    ...
    input4.setAttribute('id','email'+i);
